...
<br/><br/>
<%
    out.println("<div class=\"div1\"><a href=\"/user/FQGLByname?page=1&size="+ size +"&username"+username+"\">首页</a>&nbsp;");
    if (pages > 1) {
        out.println("<a href=\"/user/FQGLByname?page="+ (pages-1) +"&size="+ size +"&username"+username+"\">上一页</a>&nbsp;");
    }
    out.println("第"+ pages +"/"+ ((total+size-1)/size) +"页&nbsp;&nbsp;&nbsp;");
    out.println("共"+ total +"条数据&nbsp;&nbsp;&nbsp;");
    if (pages < ((total+size-1)/size)) {
        out.println("<a href=\"/user/FQGLByname?page="+ (pages+1) +"&size="+ size +"&username"+username+"\">下一页</a>&nbsp;");
    }
    out.println("<a href=\"/user/FQGLByname?page="+ ((total+size-1)/size) +"&size="+ size +"&username"+username+"\">尾页</a>&nbsp;</div>");
%>
