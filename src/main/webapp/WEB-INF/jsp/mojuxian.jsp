...
<div class="div">
    <form action="/user/FuzzyQueryByUsername" method="post">
...
<%
    out.println("<div class=\"div1\"><a href=\"/user/FuzzyQueryByUsername?page=1&size="+ size +"&username="+session.getAttribute("search")+"\">首页</a>&nbsp;");
    if (pages > 1) {
        out.println("<a href=\"/user/FuzzyQueryByUsername?page="+ (pages-1) +"&size="+ size +"&username="+session.getAttribute("search")+"\">上一页</a>&nbsp;");
    }
    out.println("第"+ pages +"/"+ ((total+size-1)/size) +"页&nbsp;&nbsp;&nbsp;");
    out.println("共"+ total +"条数据&nbsp;&nbsp;&nbsp;");
    if (pages < ((total+size-1)/size)) {
        out.println("<a href=\"/user/FuzzyQueryByUsername?page="+ (pages+1) +"&size="+ size +"&username="+session.getAttribute("search")+"\">下一页</a>&nbsp;");
    }
    out.println("<a href=\"/user/FuzzyQueryByUsername?page="+ ((total+size-1)/size) +"&size="+ size +"&username="+session.getAttribute("search")+"\">尾页</a>&nbsp;</div>");
%>
